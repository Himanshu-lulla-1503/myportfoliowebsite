	...
	<div class="row customrow pb-2 ">
		<div class="col-6 align-self-center  pb-2 ">
			...
			<div class="d-flex mb-3  justify-content-around justify-content-sm-center">
				<div class="social">
					<a href=" https://wa.me/+919039494048" target="_blank" class="text-decoration-none text-white  mx-1 mx-sm-2"><i class="fa fa-whatsapp fa-2x" aria-hidden="true"></i></a>
				</div>
				<div class="social">
					<a href="https://www.instagram.com/himanshu_lulla/" target="_blank" class="text-decoration-none text-white  mx-1 mx-sm-2"><i class="fa fa-instagram fa-2x" aria-hidden="true"></i></a>
				</div>
				<div class="social">
					<a href="https://www.linkedin.com/in/himanshu-lulla-1503" target="_blank" class="text-decoration-none text-white  mx-1 mx-sm-2"><i class="fa fa-linkedin fa-2x" aria-hidden="true"></i></a>
				</div>
				<div class="social">
					<a href="https://github.com/Himanshu-lulla-1503" target="_blank" class="text-decoration-none text-white  mx-1 mx-sm-2"><i class="fa fa-git fa-2x" aria-hidden="true"></i></a>
				</div>
			</div>
		...
		<div class="col-6 col-md-5 align-self-start   d-flex justify-content-end ">
			<img src="https://joeschmoe.io/api/v1/himanshu7" class="img-fluid   customimg" alt="This is my image">
		</div>
	</div>	
</div>
</header>
...
<div class="tab-content " id="dynamictabs">
	<div class="tab-pane container active" id="webd">
		<div class="row mt-3 " >
			...
			<div class="col-md-4 col-6 mb-5">
				<div class="single-skill justify-content-center d-flex">
					<div class="circlechart" data-percentage="80" >JS</div>
				</div>
			</div>
				<div class="col-md-4 col-6 mb-5  ">
				<div class="single-skill justify-content-center d-flex">
			...
			<div class="col-md-4 col-6 mb-5">
				<div class="single-skill justify-content-center d-flex">
					<div class="circlechart" data-percentage="80" >Node</div>
				</div>
			</div>
			<div class="col-md-4 col-6 mb-5">
				<div class="single-skill justify-content-center d-flex">
					<div class="circlechart" data-percentage="80" >Express</div>
				</div>
			</div>
			<div class="col-md-4 col-6 mb-5">
				<div class="single-skill justify-content-center d-flex">
					<div class="circlechart" data-percentage="80" >Mongo</div>
				</div>
			</div>
			<div class="col-md-4 col-6 mb-5">
				<div class="single-skill justify-content-center d-flex">
					<div class="circlechart" data-percentage="75">Mongoose</div>
				</div>
			</div>
			<div class="col-md-4 col-6 mb-5">
				<div class="single-skill justify-content-center d-flex">
	...
	<div class="tab-pane container fade" id="certi">
		<div class="row mt-3" id="mycertificates">
			<div class="col-md-4 col-sm-6 col-10 mx-auto mx-sm-0 mb-5">
...
<div class="col-md-4 col-10 mx-auto mx-sm-0  col-sm-6 mb-5 ">
	<div class="card shadow-lg" >
...
<div class="col-md-4 col-10 mx-auto mx-sm-0  col-sm-6 mb-5">
<div class="card shadow-lg" >
	<img class="card-img-top" src="img/weather.jpg" alt="Card image"  class="img-fluid">
	<div class="card-body">
		<h4 class="card-title font-weight-bold">Weatherify Webapp</h4>
		<p class="card-text">It's a weather web app which shows the current weather conditions of searched city. Real Time Api is used to fetch the  weather conditions </p>
		<a href="https://weather-ify.herokuapp.com" target="_blank" type="button" class="btn btn-primary stretched-link">
		See Project
		</a>
	</div>
</div>
...
<div class="card shadow-lg" >
	...
	<div class="card-body">
		<h4 class="card-title font-weight-bold">Feedback System</h4>
		<p class="card-text">I have developed Student Feedback System for my university using the WAMP(Windows,Apache,Mysql,PHP) Stack of Web Developement</p>
...
<div class="card shadow-lg" >
	...
	<div class="card-body">
		...
		<p class="card-text">My Portfolio Website developed using using the WAMP(Windows,Apache,Mysql,PHP) Stack of Web Developement</p>
		<a href="index.php" type="button" class="btn btn-primary stretched-link">
		See Project
		</a>
	</div>
</div>
...
<div class="card shadow-lg" >
	...
	<div class="card-body">
		...
		<p class="card-text">I have designed frontend for an e-commerce website using Html , Css , Bootstrap ,Jquery and Advanced Css.</p>
		<a href="#" type="button" class="btn btn-primary stretched-link">
		See Project
		</a>
	</div>
...
<footer class="mt-5">
	<h5 class="display-6 text-center">&copy;Created by Himanshu Lulla</h5>
</footer>
